...
<div class="max-w-2xl mx-auto p-4 bg-white shadow-md rounded-lg mt-6">
    <h1 class="text-2xl font-semibold text-gray-900 mb-6">Tạo Vai Trò Mới</h1>
    ...
    <form action="{{ route('roles.store') }}" method="POST" class="space-y-4">
        ...
        <div>
            <label for="name" class="block text-gray-700 text-sm font-bold mb-2">Tên Vai Trò</label>
        ...
        <div>
            <label for="permissions" class="block text-gray-700 text-sm font-bold mb-2">Quyền</label>
            <select multiple id="permissions" name="permissions[]" class="block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-2 px-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 @error('permissions') border-red-500 @enderror">
