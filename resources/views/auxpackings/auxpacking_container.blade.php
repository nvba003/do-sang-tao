...
<div class="container mx-auto px-2 sm:px-3 lg:px-4">
    ...
    <div class="bg-white shadow-md rounded-lg my-1 overflow-x-auto p-2 sm:p-4" x-data="containerTable()">
        ...
        <table id="containerTable" class="w-full bg-white border border-gray-200 rounded-lg">
            <thead class="text-white bg-gray-500">
                <tr>
                    ...
                    <th scope="col" class="w-4/24 px-2 py-3 text-left text-xs md:text-sm font-semibold uppercase tracking-wider">ID</th>
                    ...
                    <th scope="col" class="w-4/24 px-2 py-3 text-left text-xs md:text-sm font-semibold uppercase tracking-wider">Vị trí</th>
                    <th scope="col" class="w-2/24 px-2 py-3 text-left text-xs md:text-sm font-semibold uppercase tracking-wider">No.</th>
                    <th scope="col" class="w-4/24 px-2 py-3 text-left text-xs md:text-sm font-semibold uppercase tracking-wider">Tên sản phẩm</th>
                    <th scope="col" class="w-3/24 px-2 py-3 text-left text-xs md:text-sm font-semibold uppercase tracking-wider">Số đơn</th>
                    <th scope="col" class="w-5/24 px-2 py-3 text-left text-xs md:text-sm font-semibold uppercase tracking-wider">Thao tác</th>
                </tr>
            </thead>
                @include('auxpackings.partial_auxpacking_container_table', ['containers' => $containers, 'users' => $users])
        </table>
...
<script>
    ...
    function containerTable() {
        return {
            containers: [], // Dữ liệu sản phẩm sẽ được tải vào đây
            init() {
