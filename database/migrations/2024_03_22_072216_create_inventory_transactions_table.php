...
class CreateInventoryTransactionsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('inventory_transactions', function (Blueprint $table) {
            ...
            $table->foreign('container_id')->references('id')->on('containers')->onDelete('cascade'); // Khóa ngoại tham chiếu đến Containers
            ...
            $table->unsignedTinyInteger('type')->comment('1: Nhap, 2: Xuat, 3: Kiem'); // Loại giao dịch: nhập kho (in) hoặc xuất kho (out) hoặc kiểm hàng SL còn thực tế (check)
